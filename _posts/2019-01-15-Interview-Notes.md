...
#### R-CNN（region）
![1547697433609](/assets/images/2019-01-15/1547697433609.png)
...
#### Fast R-CNN
![1547697486664](/assets/images/2019-01-15/1547697486664.png)
- entire image
- RoIs (region of interests) and wrap image region
- CNN
- classification and bbox coordinates
#### Faster R-CNN
![1547697524639](/assets/images/2019-01-15/1547697524639.png)
- entire image
- CNN and region proposal network
- project region proposals to conv feature map
- classification and bbox coordinates
#### Mask R-CNN
![1547697552337](/assets/images/2019-01-15/1547697552337.png)
- entire image
- CNN and region proposal network
- project region proposals to conv feature map
- predict a mask
...
- 将输入图像分割成G×G的网格，对于每个网格单元，运行一个CNN网络，运行 **non-max suppression**（选择最大概率的边界框并将与其交并比50的边界框删除） 算法，删除任何可能的重复重叠边界框。
  ![Alt text](/assets/images/2019-01-15/1546504491715.png)
